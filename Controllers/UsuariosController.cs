...
namespace waAlquimia.Controllers
{
    ...
    {
        private readonly DbAlquimiaContext _context;

        public UsuariosController(DbAlquimiaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Usuarios != null ? 
                          ...
                          Problem("Entity set 'DbAlquimiaContext.Usuarios'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DbAlquimiaContext.Usuarios'  is null.");
            }
            var usuario = await _context.Usuarios.FindAsync(id);
            if (usuario != null)
            {
        ...
        public async Task<IActionResult> Login(int id, [Bind("Email,Password")] Usuario usuario)
        {
            ...
            if (res)
            {
                ...
                var datPer = _context.Usuarios.Find(res_u.Id);
