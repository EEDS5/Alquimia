...
(function($) {
    "use strict";
		...
		jQuery(".orange-bg").on('click',function(){
			jQuery(".logo-header img").attr("src", "images/LOGO-FINAL.png");
			jQuery(".footer-logo .text-center img").attr("src", "images/LOGO-FINAL.png");
			return false;
		});

		jQuery(".strong-blue-bg").on('click',function(){
			jQuery(".logo-header img").attr("src", "images/LOGO-FINAL2.png");
			jQuery(".footer-logo .text-center img").attr("src", "images/LOGO-FINAL2.png");
			return false;
		});

		jQuery(".moderate-green-bg").on('click',function(){
			jQuery(".logo-header img").attr("src", "images/LOGO-FINAL3.png");
			jQuery(".footer-logo .text-center img").attr("src", "images/LOGO-FINAL3.png");
			return false;
		});

		jQuery(".vivid-yellow-bg").on('click',function(){
			jQuery(".logo-header img").attr("src", "images/LOGO-FINAL4.png");
			jQuery(".footer-logo .text-center img").attr("src", "images/LOGO-FINAL4.png");
			return false;
		});
